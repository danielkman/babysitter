...
export const RESOURCE_DEFINITIONS = Object.freeze({
  ...
  KrateWorkspace: { storage: 'postgres', context: 'agents', plural: 'krateworkspaces', purpose: 'Git worktree/runtime inventory with lifecycle state and ownership', requiredSpec: ['organizationRef', 'repository', 'workspacePath', 'ownership'] },
  ...
  KrateProject: { storage: 'etcd', context: 'agents', plural: 'krateprojects', purpose: 'Project grouping issues with kanban board config, default workflow, and team refs', requiredSpec: ['organizationRef', 'displayName'] },
