...
| title | DiscoverySignal NodeKind from repo atlas-catalog absent in v6 schema |
| level | 1 |
| priority | P1 |
...
## Evidence
- packages/atlas-catalog/graph/schema/ontology-schema.yaml (lines 172-182)
- packages/atlas-catalog/graph/nodes/agents/ (live signal data)
...
- Level 2: this resolves OpenQuestion "How do live atlas-catalog 22 NodeKinds collapse into v6 schema NodeKinds?" partially.
