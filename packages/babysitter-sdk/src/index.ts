...
// compaction moved to @a5c-ai/genty-platform (GAP-PERF-002)
// mcpClient moved to @a5c-ai/genty-platform (GAP-REMOTE-006)
// mcpChannels moved to @a5c-ai/genty-platform (interactive feature)
