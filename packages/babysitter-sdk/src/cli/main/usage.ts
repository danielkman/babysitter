...
function coreHumanUsage(commandName: string): string {
  ...
  ${commandName} blueprints:install [<name>] [--plugin-name <name>] [--plugin-version <ver>] [--global|--project] [--json] [--verbose]
  ${commandName} blueprints:uninstall [<name>] [--plugin-name <name>] [--global|--project] [--json] [--verbose]
  ${commandName} blueprints:update [<name>] [--plugin-name <name>] [--plugin-version <ver>] [--global|--project] [--json] [--verbose]
  ${commandName} blueprints:configure [<name>] [--plugin-name <name>] [--global|--project] [--json] [--verbose]
  ${commandName} blueprints:list-installed [--global|--project] [--json] [--verbose]
  ${commandName} blueprints:list --marketplace-name <name> [--global|--project] [--json] [--verbose]
  ${commandName} blueprints:add-marketplace --marketplace-url <url> [--marketplace-path <path>] [--marketplace-branch <ref>] [--force] [--global|--project] [--json] [--verbose]
...
Harness runtime commands are provided by the optional ${"@a5c-ai/genty-platform"} package:
