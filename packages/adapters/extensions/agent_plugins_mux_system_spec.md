...
npx @a5c-ai/adapters-extensions diff --target claude-code --existing artifacts/generated-plugins/claude-code
```
...
```bash
npx @a5c-ai/adapters-extensions diff --target codex --existing artifacts/generated-plugins/codex
```
...
|----------------|---------|--------|
| `packages/adapters/hooks/adapter-claude/` | Claude Code | shell-hook |
| `packages/adapters/hooks/adapter-codex/` | Codex | shell-hook |
| `packages/adapters/hooks/adapter-cursor/` | Cursor | shell-hook |
| `packages/adapters/hooks/adapter-gemini/` | Gemini CLI | shell-hook |
| `packages/adapters/hooks/adapter-copilot/` | GitHub Copilot | shell-hook |
| `packages/adapters/hooks/adapter-opencode/` | OpenCode | in-process |
| `packages/adapters/hooks/adapter-openclaw/` | OpenClaw | in-process |
| `packages/adapters/hooks/adapter-pi/` | Pi | in-process |
| `packages/adapters/hooks/adapter-oh-my-pi/` | oh-my-pi | in-process |
...
npx @a5c-ai/adapters-extensions diff --target codex --existing artifacts/generated-plugins/codex
npx @a5c-ai/adapters-extensions diff --target pi --existing artifacts/generated-plugins/pi
npx @a5c-ai/adapters-extensions diff --target all --existing artifacts/generated-plugins
```
