...
npx @a5c-ai/extensions-adapter diff --target claude-code --existing artifacts/generated-plugins/claude-code
```
...
```bash
npx @a5c-ai/extensions-adapter diff --target codex --existing artifacts/generated-plugins/codex
```
...
npx @a5c-ai/extensions-adapter diff --target codex --existing artifacts/generated-plugins/codex
npx @a5c-ai/extensions-adapter diff --target pi --existing artifacts/generated-plugins/pi
npx @a5c-ai/extensions-adapter diff --target all --existing artifacts/generated-plugins
```
