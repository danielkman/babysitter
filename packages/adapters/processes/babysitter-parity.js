...
const analyzeBabysitterTask = defineTask('analyze-babysitter-sdk', (args, taskCtx) => ({
  ...
  agent: {
    ...
    prompt: {
      ...
      task: 'Read every harness-adapter source file under github.com/a5c-ai/babysitter (staging branch) and compare to packages/adapters/adapters/src/. Identify features, edge-case handling, and error paths we may be missing.',
      instructions: [
        ...
        'Cross-reference against our packages/adapters/adapters/src/<name>-adapter.ts.',
