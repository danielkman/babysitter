...
Iterative, spec-driven TDD implementation of `@a5c-ai/adapters` across 10 phases plus project scaffolding. Each phase follows a 3-part cycle: plan, implement+test, refactor+integrate. Adversarial reviews score implementation against specs with a 99% convergence target.
