  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        `Inspect the repository under "${args.projectRoot}", especially packages/adapters/observability, packages/adapters/core, packages/adapters/cli, packages/adapters/tui, and any docs or tests referencing logging or telemetry.`,
