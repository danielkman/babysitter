  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        '(imported from @a5c-ai/adapters-comm) so it gets cleaned up on uncaught exceptions.',
        ...
        'In packages/adapters/core/src/provider-profiles.ts, after reading ~/.amux/providers.json,',
  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        'Add a /v1/models endpoint to packages/adapters/amux-proxy/src/amux_proxy/server.py that queries',
        ...
        'Create packages/adapters/amux-proxy/src/amux_proxy/providers/ollama_server.py with OllamaServerManager',
  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        'Import from @a5c-ai/adapters-comm: PROVIDER_DEFAULTS, MODEL_TRANSLATION_TABLE.',
        '',
        ...
        '  "test:amux-proxy": "cd packages/adapters/amux-proxy && python -m pytest tests/ -v"',
        '  "lint:amux-proxy": "cd packages/adapters/amux-proxy && ruff check ."',
        '',
...
const verifyAllTask = defineTask('verify-all', (args, taskCtx) => ({
  ...
  shell: {
    command: [
      ...
      'cd packages/adapters/amux-proxy && python -m pytest tests/ -v',
    ].join(' && '),
    expectedExitCode: 0,
    timeout: 300000,
  },
