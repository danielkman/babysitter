...
def test_from_env_defaults(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setenv("ADAPTERS_PROXY_TARGET_PROVIDER", "bedrock")
    monkeypatch.setenv("ADAPTERS_PROXY_TARGET_MODEL", "bedrock/anthropic.claude-sonnet-4")
    monkeypatch.setenv("ADAPTERS_PROXY_EXPOSED_TRANSPORT", "anthropic")
