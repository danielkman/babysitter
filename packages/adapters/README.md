...
> Use this README as the canonical family entrypoint for the adapters workspace tree.
<!-- docs-status:end -->
...
The standalone checkout at `/home/a5cdev/work/adapters` is now only a moved notice.
