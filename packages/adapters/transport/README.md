...
1. `packages/adapters/cli/src/commands/launch.ts` decides whether a proxy is needed.
2. `packages/adapters/core/src/provider-resolver.ts` resolves canonical provider config.
