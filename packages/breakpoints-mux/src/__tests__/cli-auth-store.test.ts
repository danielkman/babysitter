...
describe("CLI Auth Store", () => {
  ...
  describe("getBmuxDir", () => {
    it("returns path under homedir", async () => {
      ...
      expect(dir).toBe(join(testHomeDir, ".breakpoints-mux"));
    });
  });
  ...
  describe("getAuthStorePath", () => {
    it("returns auth.json path", async () => {
      ...
      expect(path).toBe(join(testHomeDir, ".breakpoints-mux", "auth.json"));
    });
  });
  ...
  describe("getClientConfigPath", () => {
    it("returns config.json path", async () => {
      ...
      expect(path).toBe(join(testHomeDir, ".breakpoints-mux", "config.json"));
    });
  });
  ...
  describe("getKeysDir", () => {
    it("returns keys directory path", async () => {
      ...
      expect(dir).toBe(join(testHomeDir, ".breakpoints-mux", "keys"));
    });
  });
  ...
  describe("saveAuthState / loadAuthState", () => {
    ...
    it("creates .breakpoints-mux directory if it does not exist", async () => {
