...
const BMUX_DIR = ".breakpoints-mux";
...
/**
 * Get the path to the breakpoints-mux config directory (~/.breakpoints-mux).
 */
...
/**
 * Get the path to the auth state file (~/.breakpoints-mux/auth.json).
 */
...
/**
 * Get the path to the client config file (~/.breakpoints-mux/config.json).
 */
...
/**
 * Get the path to the SSH keys directory (~/.breakpoints-mux/keys).
 */
...
/**
 * Load CLI/MCP client configuration from ~/.breakpoints-mux/config.json.
 */
...
/**
 * Save or update CLI/MCP client configuration in ~/.breakpoints-mux/config.json.
 */
...
/**
 * Load the stored authentication state from ~/.breakpoints-mux/auth.json.
...
/**
 * Save authentication state to ~/.breakpoints-mux/auth.json.
...
/**
 * Clear the stored authentication state by removing ~/.breakpoints-mux/auth.json.
 */
