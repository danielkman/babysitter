/**
 * Formats genty invocation results as adapters compatible
 * JSONL events.
 *
...
import { mapHarnessToAmuxAdapter, hasAmuxAdapter } from "@a5c-ai/genty-platform/harness";
 ...
 * representing adapters compatible events.
 *
 * Events emitted:
