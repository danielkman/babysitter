...
class AdapterFirebaseMessagingService : FirebaseMessagingService() {
  override fun onMessageReceived(message: RemoteMessage) {
    val manager = getSystemService(NotificationManager::class.java)
    manager.createNotificationChannel(NotificationChannel("adapter-hooks", "AgentMux Hooks", NotificationManager.IMPORTANCE_DEFAULT))
    ...
    val notification = NotificationCompat.Builder(this, "adapter-hooks")
