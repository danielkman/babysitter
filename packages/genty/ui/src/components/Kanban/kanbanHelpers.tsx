...
// ---------------------------------------------------------------------------
// kanbanHelpers.ts — shared styles, constants, drag-and-drop utilities,
// and presentational sub-components for the Kanban board.
// ---------------------------------------------------------------------------
...
export function priorityColor(priority: string | undefined | null): string {
...
export interface DragHandlerOptions {
  dragItemRef: React.MutableRefObject<KanbanIssue | null>;
...
export function createDragHandlers({ dragItemRef, setDraggingId, setDragOverCol }: DragHandlerOptions) {
  function handleDragStart(e: React.DragEvent, item: KanbanIssue) {
...
export function CardDetailModal({ item, onClose, columnColor, org = 'default' }: CardDetailModalProps): JSX.Element {
...
export interface StartWorkDialogProps {
  item: KanbanIssue;
  onConfirm: (item: KanbanIssue) => Promise<void>;
  onCancel: () => void;
  org?: string;
}

export function StartWorkDialog({ item, onConfirm, onCancel, org }: StartWorkDialogProps): JSX.Element {
