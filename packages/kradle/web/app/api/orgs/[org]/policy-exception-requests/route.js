import { createKradleApiController, createControllerUiModel, orgNamespaceName, clearSnapshotCache } from '@a5c-ai/kradle-sdk';
...
export const POST = withAuth(async (request, { params }) => {
  ...
  try {
    ...
    const resource = {
      ...
      metadata: { name, namespace, labels: { 'kradle.a5c.ai/org': org, 'kradle.a5c.ai/surface': input.surface || 'policy' } },
      spec: {
        organizationRef: org,
