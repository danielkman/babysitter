import { collectKradleHealthProbes, createKradleApiController, healthStatusValue, orgNamespaceName } from '@a5c-ai/kradle-sdk';
...
export const GET = withAuth(async (_request, { params }) => {
  ...
  try {
    const probeDetails = await collectKradleHealthProbes({ timeoutMs: 3000 });
    const health = {
