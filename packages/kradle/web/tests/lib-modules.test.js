...
// ---------------------------------------------------------------------------
// kradle-ui.jsx (source inspection -- cannot import JSX in raw Node)
// ---------------------------------------------------------------------------

const kradleUiSrc = readSrc('app', 'lib', 'kradle-ui.jsx');

test('kradle-ui.jsx exports loadKradleUi', () => {
  assert.match(kradleUiSrc, /export\s+async\s+function\s+loadKradleUi/);
});

test('kradle-ui.jsx exports orgHref', () => {
  assert.match(kradleUiSrc, /export\s+function\s+orgHref/);
});

test('kradle-ui.jsx exports StatusPill component', () => {
  assert.match(kradleUiSrc, /export\s+function\s+StatusPill/);
});

test('kradle-ui.jsx exports DegradedBanner component', () => {
  assert.match(kradleUiSrc, /export\s+function\s+DegradedBanner/);
});
