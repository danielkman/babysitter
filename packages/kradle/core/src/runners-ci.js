...
export class RunnerScheduler {
  ...
  createRunnerPool({ name, namespace = 'kradle-org-default', organizationRef = 'default', image = 'ubuntu:24.04', warmReplicas = 1, maxReplicas = 10, trustTier = 'trusted', cache = { type: 'object-storage' } }, user) {
  ...
  startPipeline({ name, namespace = 'kradle-org-default', organizationRef = 'default', repository, ref, actor, steps = ['checkout', 'test'], fork = false, resumeFrom = null }, user) {
