export const KRADLE_COMPONENTS = Object.freeze([
  { id: 'control-plane', title: 'Control Plane', area: 'api', resources: ['Repository', 'BranchProtection', 'RefPolicy'], evidence: ['src/control-plane.js', 'charts/kradle/crds'] },
  { id: 'data-plane', title: 'Repository Data Plane', area: 'git', resources: ['Repository'], evidence: ['src/data-plane.js', 'src/gitea-backend.js', 'charts/kradle/templates/gitea.yaml'] },
  ...
  { id: 'operations-publishing', title: 'Operations and Publishing', area: 'release', resources: ['APIService', 'Deployment'], evidence: ['src/operations.js', 'charts/kradle', 'scripts/setup-minikube.mjs'] },
  { id: 'web-ui', title: 'Web UI', area: 'experience', resources: ['View'], evidence: ['src/web-ui.js', 'public/index.html'] }
]);

export function createKradleComponentCatalog(demo) {
  ...
  return KRADLE_COMPONENTS.map((component) => ({
    ...component,
...
export function createKradleLifecycleSnapshot(demo, { packageInfo = {}, generatedAt = new Date().toISOString() } = {}) {
