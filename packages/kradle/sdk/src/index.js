/** Create a Kradle API controller for a given namespace, providing resource CRUD and org-scoped operations. */
export { createKradleApiController, KRADLE_API_CONTROLLER_BOUNDARY } from '../../core/src/api-controller.js';

/** Fetch the controller UI model from a running Kradle API server for dashboard rendering. */
...
export {
  ...
  mapLoginProfileToKradleIdentity,
  profileFromDelegatedHeaders,
  createInviteResource,
  createTeamResource
} from '../../core/src/auth.js';

/** Map an OIDC identity to a Kradle workspace identity with groups and UID. */
export { mapOidcIdentity } from '../../core/src/identity-policy.js';

/** Resource model: create, validate, and serialize Kradle CRD resources across all 89 kinds. */
export {
  createResource,
  validateResource,
...
/** External sync controller for reconciling resources from external backends into Kradle. */
...
/** External write controller for pushing Kradle resource changes back to external backends. */
export { createWriteController } from '../../core/src/external/write-controller.js';
/** External conflict controller for detecting and resolving sync conflicts between Kradle and backends. */
...
/** Shared Kradle dependency health probes for web/API health surfaces. */
export { collectKradleHealthProbes, healthStatusValue } from '../../core/src/health-probes.js';
...
export {
  ...
  KSERVE_API_GROUP,
  KSERVE_API_VERSION
} from '../../core/src/kradle-inference-service-controller.js';
