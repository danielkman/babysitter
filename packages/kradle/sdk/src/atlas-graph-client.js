/**
 * Atlas graph client for the kradle AgentStack builder.
 *
...
export const STACK_LAYERS = [
  ...
  { key: 'layer:4-platform', label: 'Platform', kind: 'stack-layer', position: 4, atlasKinds: ['AgentProduct', 'AgentRuntimeImpl', 'AgentPlatformImpl', 'AgentCoreImpl', 'Platform'], description: 'Agent platform target (adapters supported agents only)' },
