...
export const styles = {
  ...
  sidebarTitle: { fontWeight: 700, fontSize: 13, color: 'var(--text)', margin: 0 } as React.CSSProperties,
  newBtn: {
    padding: '4px 10px', fontSize: 12, fontWeight: 600, cursor: 'pointer',
    background: 'var(--accent, #2563eb)', color: '#fff', border: 'none', borderRadius: 4,
  } as React.CSSProperties,
  sessionList: { flex: 1, overflow: 'auto', padding: '4px 0' } as React.CSSProperties,
  ...
  sessionLabel: { fontWeight: 600, fontSize: 12, display: 'block', marginBottom: 2 } as React.CSSProperties,
  sessionMeta: { fontSize: 11, color: 'var(--text-muted)', display: 'block' } as React.CSSProperties,
  sessionDelete: {
    fontSize: 10, color: 'var(--danger)', cursor: 'pointer', float: 'right',
    background: 'none', border: 'none', padding: '0 4px', fontWeight: 700,
  } as React.CSSProperties,
  main: { flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0, position: 'relative' } as React.CSSProperties,
  toolbar: {
    padding: '8px 16px', borderBottom: '1px solid var(--border)',
    display: 'flex', alignItems: 'center', gap: 10, background: 'var(--surface)',
  } as React.CSSProperties,
  stackLabel: { fontSize: 12, fontWeight: 600, color: 'var(--text-muted)' } as React.CSSProperties,
  stackSelect: {
  ...
  copyBtnHover: { background: 'var(--surface-overlay)' } as React.CSSProperties,
  /* ── code blocks ── */
  codeBlock: {
  ...
  usage: { fontSize: 10, color: 'var(--text-muted)', marginTop: 2 } as React.CSSProperties,
  /* ── input area ── */
  inputRow: {
  ...
  thinkingDot: (delay: number): React.CSSProperties => ({
