...
Run `npm run verify:release --workspace=@a5c-ai/tula-tui` after a build to
...
```ts
import { definePlugin } from '@a5c-ai/tula-tui/plugin';
...
import { App, builtinPlugins } from '@a5c-ai/tula-tui';
