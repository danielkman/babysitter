    ...
    <section className="mx-auto flex w-full max-w-3xl flex-1 items-center justify-center px-6 py-10">
      <div className="w-full rounded-3xl border border-border bg-card p-8 shadow-lg">
        ...
        <h1 className="text-2xl font-semibold tracking-tight">
          {props.title ?? "Connect adapters before using this page"}
        </h1>
        <p className="mt-3 text-sm leading-6 text-foreground-muted">
          {props.body ??
            "This surface wraps live adapters sessions and hooks. Connect through the gateway login flow, then come back here."}
        </p>
