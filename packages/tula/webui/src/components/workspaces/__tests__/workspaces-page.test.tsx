        ...
        workspaces: [
          {
            ...
            rebase: {
              ...
              attemptCount: 1,
              unresolvedFiles: ["packages/adapters/webui/src/lib/workspace-lifecycle.ts"],
              resolvedFiles: ["packages/adapters/webui/src/components/workspaces/workspaces-page.tsx"],
              followUpInstructions: [
                "Unresolved files: packages/adapters/webui/src/lib/workspace-lifecycle.ts.",
        ...
        workspaces: [
          {
            ...
            rebase: {
              ...
              attemptCount: 2,
              unresolvedFiles: [],
              resolvedFiles: ["packages/adapters/webui/src/lib/workspace-lifecycle.ts"],
        ...
        comments: [
          {
            ...
            anchor: {
              fileId: "file-1",
              filePath: "packages/adapters/webui/src/components/workspaces/workspace-details-sidebar.tsx",
              hunkId: "hunk-1",
              side: "head",
              line: 120,
            },
