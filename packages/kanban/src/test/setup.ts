...
vi.mock('lucide-react', () => {
  ...
  const iconNames = [
    ...
    'Columns3', 'CornerDownRight', 'ExternalLink', 'Eye', 'EyeOff', 'FileDiff', 'FileImage', 'FileJson', 'FileStack', 'FileText', 'Files', 'FolderGit2', 'FolderOpen',
    'GitBranch', 'Github',
    'Hand', 'Hammer', 'Hash', 'HelpCircle', 'History', 'Inbox', 'Info', 'Layers',
    'GripVertical', 'LayoutDashboard', 'Laptop2', 'Loader2', 'LoaderCircle', 'Logs', 'MessagesSquare', 'MessageSquareText', 'MessageSquareWarning', 'Moon', 'Palette', 'PanelLeft', 'PanelRight', 'PlayCircle', 'PlaySquare',
    'Pause', 'Percent', 'Pin', 'PinOff', 'Play', 'Plus', 'Power', 'Puzzle', 'RefreshCw', 'Search', 'Settings', 'Sparkles',
    'ShieldAlert', 'ShieldCheck', 'Siren', 'Smartphone', 'Sun', 'TabletSmartphone', 'Tag', 'Terminal', 'Timer', 'TimerReset', 'Trash2',
    'TerminalSquare', 'UserRoundPlus', 'Users', 'Webhook', 'Wifi', 'WifiOff', 'Workflow',
    'Link2', 'ListTodo', 'WandSparkles', 'Wrench', 'Archive', 'RotateCcw',
    'Radar',
    'X', 'XCircle',
  ];
