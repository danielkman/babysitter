...
The reusable action at `packages/agent-mux/triggers/action.yml` supports all harnesses, providers, and invocation modes.

### Quick Start

```yaml
- uses: a5c-ai/babysitter/packages/agent-mux/triggers@main
  with:
    harness: claude
    provider: foundry
    model: gpt-5.5
