...
- `packages/core` — `@a5c-ai/agent-mux-comm`
...
2. **Bump every package.**
   ...
   - Update every workspace cross-dependency pin (`@a5c-ai/agent-mux-comm`, `-adapters`, `-cli`) to the new version in the packages that depend on them.
