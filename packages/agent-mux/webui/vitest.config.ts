...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@a5c-ai/agent-mux-comm/automation': path.resolve(rootDir, '..', 'core', 'src', 'automation.ts'),
      '@a5c-ai/agent-mux-comm/kanban': path.resolve(rootDir, '..', 'core', 'src', 'kanban.ts'),
      '@a5c-ai/agent-mux-comm/browser': path.resolve(rootDir, '..', 'core', 'src', 'browser.ts'),
      '@a5c-ai/agent-mux-comm': path.resolve(rootDir, '..', 'core', 'src', 'index.ts'),
