...
```typescript
import type { UnifiedHookEvent, UnifiedHookResult } from '@a5c-ai/agent-mux-hooks-core';
...
```typescript
import { registerHandler } from '@a5c-ai/agent-mux-hooks-core';
...
```typescript
// Pi
import { createConfiguredEngine } from '@a5c-ai/agent-mux-hooks-adapter-pi';
const engine = createConfiguredEngine();

// Oh-My-Pi
import { createConfiguredEngine } from '@a5c-ai/agent-mux-hooks-adapter-oh-my-pi';
const engine = createConfiguredEngine();

// OpenCode
import { createConfiguredEngine } from '@a5c-ai/agent-mux-hooks-adapter-opencode';
const engine = createConfiguredEngine();

// OpenClaw
import { createConfiguredEngine } from '@a5c-ai/agent-mux-hooks-adapter-openclaw';
const engine = createConfiguredEngine();
```
...
```typescript
import { createHooksEngine } from '@a5c-ai/agent-mux-hooks-core';
...
```typescript
import type { HookMiddleware } from '@a5c-ai/agent-mux-hooks-core';
