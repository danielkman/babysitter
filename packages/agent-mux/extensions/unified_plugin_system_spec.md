...
```bash
npx @a5c-ai/agent-mux-extensions diff --target codex --existing plugins/babysitter-codex
```
...
npx @a5c-ai/agent-mux-extensions diff --target codex --existing plugins/babysitter-codex
npx @a5c-ai/agent-mux-extensions diff --target pi --existing plugins/babysitter-pi
npx @a5c-ai/agent-mux-extensions diff --target all --existing plugins/
```
