...
```
Processes live in: blueprints/babysitter/skills/babysit/process/
...
ls blueprints/babysitter/skills/babysit/process/specializations/

# Check methodologies
ls blueprints/babysitter/skills/babysit/process/methodologies/
```
...
babysitter run:create \
  ...
  --entry ./blueprints/babysitter/skills/babysit/process/methodologies/my-process.js#process \
...
cat blueprints/babysitter/skills/babysit/process/methodologies/atdd-tdd/atdd-tdd.js | head -200

# Check methodology README structure
cat blueprints/babysitter/skills/babysit/process/methodologies/atdd-tdd/README.md
```

### 3. Check Methodologies Backlog

```bash
cat blueprints/babysitter/skills/babysit/process/methodologies/backlog.md
```
...
- **SDK Reference**: `blueprints/babysitter/skills/babysit/process/reference/sdk.md`
- **Methodology Backlog**: `blueprints/babysitter/skills/babysit/process/methodologies/backlog.md`
- **Specializations Backlog**: `blueprints/babysitter/skills/babysit/process/specializations/backlog.md`
- **Example: ATDD/TDD**: `blueprints/babysitter/skills/babysit/process/methodologies/atdd-tdd/`
- **Example: Spec-Driven**: `blueprints/babysitter/skills/babysit/process/methodologies/spec-driven-development.js`
