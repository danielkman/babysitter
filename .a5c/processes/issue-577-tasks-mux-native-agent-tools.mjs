  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        "Extract keyword nouns and verbs from the issue: tasks-mux, native tools, MCP tools, create_todo, assign_task, search_tasks, escalate, BreakpointBackend, approval chains, SDK task effects, agent-core delegation, agent-platform delegation, subtask dispatch, adapters adapters.",
  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        "The contract must cover native agent-core tools, agent-platform harness tools, tasks-mux MCP tool registration, breakpoint delegation through BreakpointBackend, approval-chain routing through tasks-mux, SDK task effects through tasks-mux for human-in-the-loop, and subtask dispatch through adapters adapters via tasks-mux.",
  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        "Include negative tests for unavailable adapters adapter, missing auth, timeout, tracker backend unavailable, and fallbackType behavior.",
  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        "Use AgentMuxResponderBackend only through tasks-mux routing for agent responder subtasks. Do not introduce direct agent-platform-to-adapters special cases that bypass tasks-mux.",
  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        "At minimum, verify focused new tests, tasks-mux test/typecheck/lint/build, SDK test/build, agent-core test/build, agent-platform test/lint/build, adapters relevant tests/build if adapter routing changed, architecture tests, metadata verification, and git diff --check.",
...
export const reviewTask = defineTask("issue-577/review", (args, taskCtx) => ({
  ...
  agent: {
    name: "code-reviewer",
    prompt: {
      role: "adversarial reviewer for tasks-mux, SDK, agent-core, agent-platform, and adapters integration",
      ...
      instructions: [
        ...
        "Confirm subtask dispatch uses tasks-mux to reach AgentMuxResponderBackend rather than direct adapters calls outside tasks-mux-owned seams.",
  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        "Require evidence for native tools, MCP registration, BreakpointBackend delegation, approval-chain routing, SDK human-in-loop task system, adapters-backed subtask dispatch, and compatibility with already-landed responder work.",
