 ...
 *   - packages/genty/platform/src/harness/invoker.ts
  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        'Scan packages/agent-core, packages/transport-mux, packages/adapters, packages/genty/platform, docs, and .a5c/processes. Note that `.a5c/process-library/` may be absent; report whether it exists.',
  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        'Check downstream compatibility with packages/genty/platform direct agent-core harness usage and existing README promises.',
