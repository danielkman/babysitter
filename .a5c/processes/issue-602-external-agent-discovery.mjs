...
const sourceOfTruthInstructions = [
  ...
  '- docs/adapters-babysitter-integrations/sdk-discovery.md',
  '- docs/adapters-babysitter-integrations/tasks-mux-routing.md',
  '- docs/adapters-babysitter-integrations/testing.md when selecting tests',
  '- packages/sdk/src/harness/discovery.ts',
  '- packages/sdk/src/harness/install.ts',
  '- packages/sdk/src/harness/index.ts',
  '- packages/sdk/src/index.ts',
  '- packages/adapters/core/src/adapter-registry.ts',
  '- packages/adapters/core/src/model-registry.ts',
  '- packages/adapters/core/src/client.ts',
  '- packages/adapters/cli/src/commands/doctor.ts',
...
const issueBoundaryInstructions = [
  ...
  'Required discovery strategy: optional adapters module discovery first, adapters doctor --json CLI fallback second, graceful unavailable result third.',
...
const architectureTask = defineTask(
  ...
  async ({ issueNumber, reuseAudit }) => ({
    ...
    labels: ['issue-602', 'architecture', 'sdk', 'tasks-mux', 'adapters'],
    agent: {
      ...
      prompt: {
        ...
        instructions: [
          ...
          'Identify the minimal local adapters client shape needed for optional dynamic import without hard SDK dependency behavior.',
          'Identify the adapters doctor --json output shape and normalization strategy.',
    ...
    agent: {
      ...
      prompt: {
        ...
        instructions: [
          ...
          'Cover unavailable optional dependency, in-process mocked adapters discovery, CLI doctor --json fallback, CLI/module failures, timeout behavior, cache hit within TTL, and force:true cache bypass.',
...
const implementationTask = defineTask(
  ...
  async ({ architecture, tests, previousReview }) => ({
    ...
    labels: ['issue-602', 'implementation', 'sdk', 'adapters'],
    agent: {
      ...
      prompt: {
        ...
        instructions: [
          ...
          'Keep @a5c-ai/adapters optional through a dynamic/optional import boundary. Do not introduce a hard runtime dependency from SDK discovery.',
          'Normalize adapters adapter registry and CLI doctor data into the requested ExternalAgentInfo and ExternalAgentDiscovery shapes.',
    ...
    agent: {
      ...
      prompt: {
        ...
        instructions: [
          ...
          '- git diff --check',
          '- grep/search guard proving packages/sdk/src/harness/externalAgentDiscovery.ts does not statically import or require @a5c-ai/adapters',
    ...
    agent: {
      ...
      prompt: {
        ...
        instructions: [
          ...
          'The review is approved only if the revised consumer contract is correct: tasks-mux matchAgentResponder() can later query discovery for installed+authenticated adapters, and SDK does not directly dispatch to adapters in this issue.',
