 ...
 * - Existing downstream consumers import @a5c-ai/agent-catalog from packages/adapters/adapters, packages/sdk, hooks-mux adapters, web../platform vitest aliases, and related package manifests.
...
function defaultPhases() {
  return [
    ...
    },
    {
      ...
      greenWork: [
        'Update packages/sdk, packages/adapters/adapters, hooks-mux adapters, agent-platform/webui test aliases, mocks, and package.json dependencies.',
