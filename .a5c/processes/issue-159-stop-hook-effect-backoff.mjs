  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        'Confirm that blueprints/babysitter-unified/hooks/stop.sh is a thin wrapper and that shared behavior belongs in the SDK hook runtime unless the current code proves otherwise.',
  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        '- Do not move policy into blueprints/babysitter-unified/hooks/stop.sh except for a necessary wrapper pass-through discovered during tracing.',
