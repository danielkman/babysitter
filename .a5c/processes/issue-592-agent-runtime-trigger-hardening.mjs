  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        "Inspect packages/agent-runtime/src/daemon first, then packages/genty/platform/src/daemon, packages/triggers-mux, packages/kradle/core trigger controllers, observability queue diagnostics, and docs/agent-layer-gaps.md.",
