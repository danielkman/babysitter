  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        "Include guard tests or assertions that prevent direct agent-mux routing from S../platform task effect resolution paths.",
      ],
  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        "Route S../platform task effect resolution through tasks-mux instead of direct agent-mux or ad hoc resolver logic.",
