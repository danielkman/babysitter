...
export async function process(inputs, ctx) {
  const {
    issueNumber = 633,
    branch = "staging",
    designDocPath = "docs/adapters-babysitter-integrations/tasks-mux-routing.md",
  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        "Reject direct SDK-to-adapters or agent-platform-to-amuxBridge routing that bypasses tasks-mux for task effects.",
  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        "Include guard tests or assertions that prevent direct adapters routing from S../platform task effect resolution paths.",
      ],
  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        "Route S../platform task effect resolution through tasks-mux instead of direct adapters or ad hoc resolver logic.",
