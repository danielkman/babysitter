  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        'Call out reusable adjacent infrastructure: jitsi-service JWT generation, Jitsi web pages, existing Jitsi CLI MCP tools, agent dispatch controller, adapters Job manifest builder, AgentStack reconciler, AgentDispatchRun CRD, and Jitsi resource model tests.',
  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        'Design adapters-client createAgentJob additions: jitsi-agent-sidecar, JITSI_ROOM_URL, JITSI_JWT, JITSI_ROOM_ID, JITSI_PARTICIPANT_NAME, JITSI_AUDIO_MODE, JITSI_CHAT_MODE, AGENT_SOCKET_PATH, main-container socket env, and shared emptyDir volume.',
...
export const implementMeetingParticipationTask = defineTask('issue-627.implementation', (args, taskCtx) => ({
  ...
  labels: ['issue-627', 'implementation', 'kradle-core', 'kradle-web', 'adapters'],
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        'Extend adapters-client createAgentJob to add the Jitsi sidecar, required env vars, main-container socket env, and shared emptyDir volume only when meeting context is present.',
