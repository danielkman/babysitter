  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        'Inspect packages/transport-mux first, then follow imports and consumers through packages/sdk cost/session code, adapters launcher/adapter surfaces, docs/plugins.md, docs/agent-layer-gaps.md, and related issue process plans.',
  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        'Use existing adapters/session surfaces where available rather than inventing unrelated session stores.',
