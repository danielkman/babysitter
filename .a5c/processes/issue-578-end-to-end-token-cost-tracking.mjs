  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        'Trace agent-platform cost APIs: packages/genty/platform/src/session/cost.ts, packages/genty/platform/src/cost/effectCost.ts, createRun orchestration/effect resolution files, and adapters event mapper cost/token_usage handling.',
  ...
  agent: {
    ...
    prompt: {
      ...
      instructions: [
        ...
        'Wire run/effect cost stats into session cost aggregation using existing packages/genty/platform/src/session/cost.ts APIs where possible.',
