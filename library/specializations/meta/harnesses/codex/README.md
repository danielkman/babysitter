...
```json
{
  ...
  "homepage": "https://github.com/a5c-ai/babysitter/tree/main/blueprints/babysitter-unified/per-harness/codex#readme",
...
> **Reference**: [codex-rs/plugin/](https://github.com/openai/codex/tree/main/codex-rs/plugin) (accessed 2026-04-02), [blueprints/babysitter-unified/per-harness/codex](https://github.com/a5c-ai/babysitter/tree/main/blueprints/babysitter-unified/per-harness/codex) (accessed 2026-05-06)
...
> **Reference**: [developers.openai.com/codex/cli/slash-commands](https://developers.openai.com/codex/cli/slash-commands) (accessed 2026-04-02), [blueprints/babysitter-unified/per-harness/codex](https://github.com/a5c-ai/babysitter/tree/main/blueprints/babysitter-unified/per-harness/codex) (accessed 2026-05-06)
...
> **Reference**: [codex-rs/hooks/](https://github.com/openai/codex/tree/main/codex-rs/hooks) (accessed 2026-04-02), [blueprints/babysitter-unified/per-harness/codex](https://github.com/a5c-ai/babysitter/tree/main/blueprints/babysitter-unified/per-harness/codex) (accessed 2026-05-06)
...
The Codex-specific source lives under `blueprints/babysitter-unified/per-harness/codex/`, and generated Codex plugin bundles are produced from that unified source during plugin compilation.
