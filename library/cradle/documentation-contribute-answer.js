  ...
  agent: {
    ...
    prompt: {
      ...
      context: {
        ...
        docSections: ['README.md', 'CLAUDE.md', 'CHANGELOG.md', 'packages/sdk/sdk.md', 'packages/sdk/README.md', 'blueprints/babysitter-unified/skills/babysit/SKILL.md']
      },
      instructions: [
    ...
    prompt: {
      ...
      context: {
        ...
        searchPaths: [
          '*.md',
          'packages/sdk/**/*.md',
          'blueprints/babysitter-unified/**/*.md',
          'docs/**/*'
        ]
      },
      instructions: [
