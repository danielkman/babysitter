  ...
  agent: {
    ...
    prompt: {
      ...
      context: {
        ...
        docSections: ['README.md', 'CLAUDE.md', 'CHANGELOG.md', 'packages/babysitter-sdk/sdk.md', 'packages/babysitter-sdk/README.md', 'plugins/babysitter-unified/skills/babysit/SKILL.md']
      },
      instructions: [
