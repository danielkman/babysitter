...
- Uninstalling does **not** affect the source library at `blueprints/babysitter/skills/babysit/process/specializations/security-compliance/`. The plugin can be reinstalled at any time.
