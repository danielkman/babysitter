...
cp library/specializations/qa-testing-automation/e2e-test-suite.js .a5c/processes/testing/
cp library/specializations/qa-testing-automation/cross-browser-testing.js .a5c/processes/testing/
```
...
cp library/specializations/qa-testing-automation/visual-regression.js .a5c/processes/testing/
```

### Add API/contract testing:
```bash
cp library/specializations/qa-testing-automation/api-testing.js .a5c/processes/testing/
cp library/specializations/qa-testing-automation/contract-testing.js .a5c/processes/testing/
```

### Add performance testing:
```bash
npm install -D k6  # or your preferred load testing tool
cp library/specializations/qa-testing-automation/performance-testing.js .a5c/processes/testing/
```

### Add mutation testing:
```bash
npm install -D @stryker-mutator/core @stryker-mutator/vitest-runner  # adjust runner for your framework
cp library/specializations/qa-testing-automation/mutation-testing.js .a5c/processes/testing/
```
...
```bash
cp library/methodologies/atdd-tdd/atdd-tdd.js .a5c/processes/testing/
cp -r library/methodologies/superpowers/skills/test-driven-development .a5c/skills/testing/
```
...
```bash
cp library/specializations/qa-testing-automation/exploratory-testing.js .a5c/processes/testing/
```

## 11. Set Up Test Metrics Dashboard

```bash
cp library/specializations/qa-testing-automation/metrics-dashboard.js .a5c/processes/testing/
...
```bash
ls library/specializations/qa-testing-automation/*.js
```

QA skills and agents:
```bash
ls library/specializations/qa-testing-automation/skills/
ls library/specializations/qa-testing-automation/agents/
```
