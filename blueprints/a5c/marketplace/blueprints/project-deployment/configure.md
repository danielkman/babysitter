...
cp library/specializations/devops-sre-platform/log-aggregation.js .a5c/processes/deployment/
cp library/specializations/devops-sre-platform/slo-sli-tracking.js .a5c/processes/deployment/

cp -r library/specializations/devops-sre-platform/skills/prometheus-grafana .a5c/skills/deployment/
cp -r library/specializations/devops-sre-platform/skills/log-analysis .a5c/skills/deployment/
```

## 4. Add Disaster Recovery

```bash
cp library/specializations/devops-sre-platform/disaster-recovery-plan.js .a5c/processes/deployment/
cp library/specializations/devops-sre-platform/backup-restore-automation.js .a5c/processes/deployment/
```

## 5. Add Cost Optimization

```bash
cp library/specializations/devops-sre-platform/cost-optimization.js .a5c/processes/deployment/
cp -r library/specializations/devops-sre-platform/skills/cloud-cost-analysis .a5c/skills/deployment/
```

## 6. Add Service Mesh

```bash
cp library/specializations/devops-sre-platform/service-mesh.js .a5c/processes/deployment/
cp -r library/specializations/devops-sre-platform/skills/service-mesh .a5c/skills/deployment/
```

## 7. Add Incident Response

```bash
cp library/specializations/devops-sre-platform/incident-response.js .a5c/processes/deployment/
cp library/specializations/devops-sre-platform/oncall-setup.js .a5c/processes/deployment/
cp -r library/specializations/devops-sre-platform/skills/incident-platforms .a5c/skills/deployment/
```
...
ls library/specializations/devops-sre-platform/*.js

# List all devops skills
ls library/specializations/devops-sre-platform/skills/
