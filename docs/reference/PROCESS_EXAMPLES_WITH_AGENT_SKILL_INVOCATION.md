...
- Babysitter skill instructions: `blueprints/babysitter-unified/skills/babysit/SKILL.md`

The plugin skill does not ship a separate `process/` tree under `blueprints/babysitter-unified/skills/babysit/`. The canonical process library is `library/`, and project-local `.a5c/processes/` copies are user-managed overrides or generated local assets.
...
- `blueprints/babysitter-unified/skills/babysit/SKILL.md` provides the Babysitter skill instructions used by harnesses.
