...
| Agent-Runtime layer | `@a5c-ai/tula-platform` | Conflates runtime with brand |
...
|---------------|---------|----------|
| HookSurface | `@a5c-ai/adapters-hooks-core` | "mux" implies multiplexing; graph says "surface" |
| HookMapping | `@a5c-ai/adapters-hooks-*` | Graph uses "mapping" not "adapter" |
