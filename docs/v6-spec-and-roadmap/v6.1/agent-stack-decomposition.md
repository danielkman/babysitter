...
|----------------|--------|-------------|
| `@a5c-ai/agent-mux-tasks` | `@a5c-ai/agent-mux-tasks` | Rename package, keep all functionality (approval routing, cryptographic signing, pluggable backends, MCP) |
...
| `@a5c-ai/agent-mux-config` | `mux:agent-config-mux` | L5-L6 |
...
| `@a5c-ai/agent-mux-hooks-*` | `mux:hooks-mux` | Cross-cutting |
| `@a5c-ai/agent-mux-transport` | `mux:transport-mux` | L3 |
| `@a5c-ai/agent-mux-extensions` | `mux:extension-mux` (renamed from extension-mux) | L6 |
| `@a5c-ai/agent-mux-tasks` | `mux:tasks-mux` (renamed from tasks-mux) | L9, L14 |
| `@a5c-ai/agent-mux-tools` | `mux:tool-mux` (new, seeded from agent-core) | L8 |
