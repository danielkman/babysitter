...
**Problem:** Provider routing is split across transport-mux (proxy), adapters-cli (translation), and agent-catalog (metadata).
...
- Used by transport-mux proxy and adapters-cli launch
