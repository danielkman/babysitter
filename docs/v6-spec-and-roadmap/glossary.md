...
The operational agent runtime package, currently `@a5c-ai/genty-platform`. It is part of the current executable stack, even though V6 treats some deeper runtime/platform naming as deferred vocabulary rather than committed package splits.
