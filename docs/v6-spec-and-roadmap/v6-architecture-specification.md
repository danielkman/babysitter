...
- document metaplugins as capability-level abstractions over plugin and hook surfaces, and document `extensions-adapter` as the compiler and distribution path for the concrete bundles those abstractions need on legacy non-Babysitter agents.
