...
| Agent plugins mux | `npm run build --workspace=@a5c-ai/adapters-extensions`, `npm run test --workspace=@a5c-ai/adapters-extensions` | Build and test coverage for the current compiler package |
| Breakpoints mux | `npm run build --workspace=@a5c-ai/adapters-tasks`, `npm run typecheck --workspace=@a5c-ai/adapters-tasks`, `npm run test --workspace=@a5c-ai/adapters-tasks` | Build, typecheck, and test coverage for the current breakpoints workspace |
...
- the accepted `@a5c-ai/tula-platform` seam contract still matches the owned top-level runtime domains and public exports,
