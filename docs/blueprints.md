...
Agent harness plugins are still called plugins. Do not rename `CLAUDE_PLUGIN_ROOT`, `PI_PLUGIN_ROOT`, `.claude/plugins/`, `packages/adapters/hooks/`, or `packages/extension-mux/` when working on blueprints.
