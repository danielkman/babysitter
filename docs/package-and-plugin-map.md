...
| `packages/transport-mux` | Public family package | [packages/transport-mux/README.md](../packages/transport-mux/README.md) | [docs/adapters/README.md](./adapters/README.md) | README is the canonical package-level contract for the published transport/proxy runtime seam. |
| `packages/triggers-mux` | Public family package | [packages/triggers-mux/README.md](../packages/triggers-mux/README.md) | [docs/adapters/README.md](./adapters/README.md) | README is the canonical package-level contract for reusable trigger/action glue used with adapters pipelines. |
