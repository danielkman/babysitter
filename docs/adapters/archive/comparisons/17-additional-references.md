...
| # | Name | URL | Stars (approx) | Language | Category | Agents supported | Relevance to adapters |
|---|---|---|---|---|---|---|---|
...
| 4 | Claude-Code-Usage-Monitor | https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor | ~6k | Python | Analytics | claude-code | ML-based burn-rate prediction — gap in adapters. |
...
| 14 | continue | https://github.com/continuedev/continue | ~26k | TS | IDE wrapper | any (Claude, GPT, local, Mistral) | VS Code/JetBrains integration — adapters has no IDE surface. |
...
## Cross-reference: features adapters lacks
...
Adding these 17 projects to the survey in `16-reference-comparison.md` does not change the top-line conclusion: **adapters remains a structural superset on the SDK surface**. However three previously-unflagged gaps emerge:
...
The UI-shaped projects (vibe-kanban, paperclip, continue) remain orthogonal: adapters is an SDK, not a UI, and should stay that way per scope doc.
