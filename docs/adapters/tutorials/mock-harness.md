...
```bash
adapters run claude --use-adapters-harness-mock --prompt "test"
```
...
adapters run claude --prompt "test"
```
...
```bash
adapters run claude --use-adapters-harness-mock --scenario tool-call --prompt "x"
```
...
adapters-harness-mock --agent claude --scenario tool-call
```
