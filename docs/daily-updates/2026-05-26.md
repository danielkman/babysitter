...
- 25ef6dd42 feat(tula): add tula agent as adapters-launchable harness with live-stack support (Tal Muskal, 40 minutes ago)
...
- 8ad1a61ad feat(atlas): model tula in atlas graph — product, version, 4 layer impls, presentation (Tal Muskal, 13 hours ago)
...
- 3451e5728 fix(live-stack): skip adapters install for tula (already linked by CI workflow) (Tal Muskal, 26 minutes ago)
