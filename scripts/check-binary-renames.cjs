...
const binaryRenames = [
  {
    ...
    legacySource: "packages/adapters/sdk/src/bin/amux.ts",
  },
  {
  ...
  },
  {
    ...
    legacySource: "packages/adapters/transport/src/bin/amux-proxy.ts",
  },
  {
    ...
    legacySource: "packages/adapters/tui/src/bin/amux-tui.tsx",
  },
  {
    packageName: "@a5c-ai/adapters-hooks-cli",
    ...
    legacySource: "packages/adapters/hooks/cli/src/cli/a5c-hooks-mux.ts",
  },
  {
    packageName: "@a5c-ai/adapters-extensions",
    ...
    legacySource: "packages/adapters/extensions/src/extension-mux.ts",
  },
  {
    packageName: "@a5c-ai/adapters-triggers",
    ...
    legacySource: "packages/adapters/triggers/src/triggers-mux.ts",
  },
  {
    packageName: "@a5c-ai/adapters-tasks",
    ...
    legacySource: "packages/adapters/tasks/src/cli/tasks-mux.ts",
  },
  {
