...
const PRIMARY_BLUEPRINT_COMMAND_SURFACES = [
  'README.md',
  'blueprints/babysitter/skills/help/SKILL.md',
  'blueprints/babysitter/skills/blueprints/SKILL.md',
  'blueprints/babysitter-unified/commands/help.md',
  'blueprints/babysitter-unified/per-harness/gemini/README.md',
  'blueprints/babysitter-unified/per-harness/openclaw/README.md',
...
const TEMPLATE_BUILDERS = {
  'blueprints': ({ description, body }) => [
    `<!-- Generated by scripts/sync-sdk-command-templates.cjs from blueprints/babysitter-unified/commands/blueprints.md. Do not edit directly. -->`,
...
${body}`,
  ...
  'assimilate': ({ description, body }) => [
    `<!-- Generated by scripts/sync-sdk-command-templates.cjs from blueprints/babysitter-unified/commands/assimilate.md. Do not edit directly. -->`,
...
${body}`,
  ...
  'cleanup': ({ description, body }) => [
    `<!-- Generated by scripts/sync-sdk-command-templates.cjs from blueprints/babysitter-unified/commands/cleanup.md. Do not edit directly. -->`,
...
${body}`,
  ...
  'contrib': ({ description, body }) => [
    `<!-- Generated by scripts/sync-sdk-command-templates.cjs from blueprints/babysitter-unified/commands/contrib.md. Do not edit directly. -->`,
...
${body}`,
  ...
  'doctor': ({ description, body }) => [
    `<!-- Generated by scripts/sync-sdk-command-templates.cjs from blueprints/babysitter-unified/commands/doctor.md. Do not edit directly. -->`,
    `[DOCTOR MODE] ${description}`,
    `{{#targetRunText}}{{targetRunText}}{{/targetRunText}}`,
    body,
  ],
  'forever': ({ description, body }) => [
    `<!-- Generated by scripts/sync-sdk-command-templates.cjs from blueprints/babysitter-unified/commands/forever.md. Do not edit directly. -->`,
...
${body}`,
  ...
  'project-install': ({ description, body }) => [
    `<!-- Generated by scripts/sync-sdk-command-templates.cjs from blueprints/babysitter-unified/commands/project-install.md. Do not edit directly. -->`,
...
${body}`,
  ...
  'retrospect': ({ description, body }) => [
    `<!-- Generated by scripts/sync-sdk-command-templates.cjs from blueprints/babysitter-unified/commands/retrospect.md. Do not edit directly. -->`,
...
${body}`,
  ...
  'user-install': ({ description, body }) => [
    `<!-- Generated by scripts/sync-sdk-command-templates.cjs from blueprints/babysitter-unified/commands/user-install.md. Do not edit directly. -->`,
...
function assertPrimaryBlueprintCommandSurfaces() {
  ...
  if (!fs.existsSync(aliasPath)) {
    failures.push('blueprints/babysitter-unified/commands/plugins.md must remain as a deprecated alias');
  } else {
    ...
    if (!aliasContent.includes('deprecated alias') || !aliasContent.includes('/babysitter:blueprints')) {
      failures.push('blueprints/babysitter-unified/commands/plugins.md must clearly point to /babysitter:blueprints as the replacement');
    }
  }
