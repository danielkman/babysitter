...
/babysitter:blueprints [action]
  Manage Babysitter blueprints: list installed blueprints, browse marketplaces, install,
  update, configure, uninstall, or create new blueprints. Blueprints are version-managed
  ...
  - create: scaffold a new blueprint package with the meta/plugin-creation process
