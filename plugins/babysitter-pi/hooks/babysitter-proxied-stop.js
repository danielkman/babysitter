#!/usr/bin/env node
/**
 * Unified Stop / Orchestration Hook for Pi
 * Routes through hooks-proxy for all hook execution.
 *
 * Fires when the Pi agent completes a turn. Checks if the current babysitter
 * run has pending effects that need attention. Delegates to
...
const LOG_FILE = path.join(LOG_DIR, "babysitter-pi-stop-hook.log");
